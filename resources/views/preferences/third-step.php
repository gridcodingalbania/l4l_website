<div class="bg-page w-full full-page-wrapper lg:h-[60vh]">
    <div class="xs:m-5  md:container flex flex-row xs:flex-col md:flex-row xs:flex-wrap md:flex-nowrap">
        <div class="flex flex-col md:mt-20 md:mb-20 w-full">
            <p class="text-4xl text-flamingo family-DM">...i tuoi occhi.</p>
        ...
        <div class="flex flex-col justify-center mt-20 mb-20 w-full">
            ...
            <div class="text-center md:w-50">
                <input type="button" id="switch_third_step" class="family-Arimo mt-8 bg-input text-white h-[46px] font-bold tracking-1p w-[204px] rounded-md cursor-pointer uppercase" value="Conferma" />
                <p class="text-gray-400 mt-5 cursor-pointer" id="skip_to_fourth_step">Skip</p>
            </div>
        </div>
    </div>
</div>