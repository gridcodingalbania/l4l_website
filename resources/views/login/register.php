<?php $siteKey = '6LfUXRgiAAAAAN-eBt4mdrMO8UqwyPmNQqaYccbP'; ?>

<div class="bg-page w-full full-page-wrapper xs:flex-col md:flex-row xs:flex-wrap md:flex-nowrap md:h-[100vh]">
    <div class="xs:m-5  md:container flex flex-row xs:flex-col md:flex-row xs:flex-wrap md:flex-nowrap">
        <div class="flex flex-col  mt-20 mb-20 w-full">
            ...
            <p class="mt-5 text-md xs:w-full md:w-2/3 leading-6 tracking-tight family-Arimo">Intro acquisizione dati e attivazione del Beauty Passport x consulenza di base: Lorem i elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minima veniam.</p>
        </div>

        <div class="flex flex-col justify-center md:mt-20 mb-20 w-full">
            ...
            <div class="flex flex-row mb-5 items-baseline">
                ...
                <p class="ml-2 xs:w-full md:w-50 family-Arimo text-sm text-label">
            ...
            <p class="xs:w-full md:w-50 family-Arimo text-sm text-label mb-5">
