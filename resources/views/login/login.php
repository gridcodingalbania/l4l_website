<div class="bg-page w-full full-page-wrapper">
    <div class="flex container flex-row justify-evenly margin-[0 auto]">
        <div class="flex flex-col mt-20 mb-20 w-full">
            <p class="text-4xl text-flamingo family-DM">Ciao!</p>
            <p class="text-4xl family-DM">Accedi al tuo account</p>
        </div>
        <div class="flex flex-col justify-center mt-20 mb-20 w-full">
            ...
            <div class="relative z-0 mt-8 w-50">
