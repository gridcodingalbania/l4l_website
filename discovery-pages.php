...
<body>
    ...
    <div class="w-full">
        <ul class="flex items-center justify-between w-full px-4 py-4 border-b-[1px] ">
            <li class="mr-6">
                <a class="text-blue-500 hover:text-red-600" href="#">Cream to Powder</a>
            </li>
            <li class="mr-6">
                <a class="text-blue-500 hover:text-red-600" href="#">Velvet</a>
            </li>
            <li class="mr-6">
                <a class="text-blue-500 hover:text-red-600" href="#">Metallic</a>
            </li>
            <li class="mr-6">
                <a class="text-blue-500 hover:text-red-600" href="#">Accessories</a>
            </li>
            <li class="mr-6">
                <a class="text-blue-500 hover:text-red-600" href="#">Roar iD</a>
            </li>
